...
<img
  className="m-0 p-1"
  src="https://cdn.bigmodel.cn/static/platform/agent/french-kiss-template.png"
/>
</td>
<td className="align-top">
...
<img
  className="m-0 p-1"
  src="https://cdn.bigmodel.cn/static/platform/agent/dance-template.png"
/>
</td>
<td className="align-top">
...
<img
  className="m-0 p-1"
  src="https://cdn.bigmodel.cn/static/platform/agent/transformation-template.png"
/>
</td>
<td className="align-top">
