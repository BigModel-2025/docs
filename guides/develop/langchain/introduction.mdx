...
def get_weather(city: str) -> str:
    ...
    # Example return
    return f"Weather in {city}: Sunny, temperature 25°C, humidity 60%"
...
# Use agent
result = agent_executor.invoke({"input": "How's the weather in Beijing today? Then help me check stock price for symbol 000001"})
print(result['output'])
```
