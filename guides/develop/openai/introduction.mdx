...
| OpenAI Model | Z.AI Equivalent | Description |
|--------------|-------------------|-------------|
| gpt-4 | glm-4.5 | Highest performance model |
| gpt-4-turbo | glm-4-air-250414 | Balanced performance and cost |
| gpt-3.5-turbo | glm-4-flash | Fast response model |
| gpt-4-vision | glm-4v-plus | Vision understanding model |
...
<CardGroup cols={2}>
  ...
  <Card title="OpenAI Official Documentation" icon="external-link" href="https://platform.openai.com/docs">
